...
class Laborator_Subscribe extends WP_Widget {
	...
	public function widget($args, $instance)
	{
		...
		<div class="subscribe">
			...
			<!-- subscribe form -->
			<form method="post" enctype="application/x-www-form-urlencoded" action="http://feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open('http://feedburner.google.com/fb/a/mailverify?uri=designaeon', 'popupwindow', 'scrollbars=yes,width=550,height=520'); return true">
	...
	public function update($new_instance, $old_instance)
	{
		...
		$old_instance['description'] = post('description');
